      ...
      <div className='flex flex-col justify-center items-center md:flex-row-reverse md:px-8 pb-8 md:pb-16'>
        <div className="flex flex-col gap-8 text-center mb-4 md:mb-0 mx-8 md:w-2/5 md:text-left">
          <div>
            ...
            <a className="block w-fit text-2xl font-bold hover:scale-105 transform transition-all cursor-pointer" href="mailto:rohna.music@gmail.com">rohna.music@gmail.com</a>
          </div>
          <div>
            <h2>Text us at:</h2>
            <a className="block w-fit text-2xl font-semi-bold hover:scale-105 transition-all cursor-pointer" href="sms:8136693877">813-669-3877</a>
          </div>
        </div>
