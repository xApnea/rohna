...
export default function Tour({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <section className="bg-[url('/resources/images?src=/images/crowbar03.jpg&w=2705&h=2048&fit=cover&format=avif')] bg-cover bg-center bg-no-repeat min-h-[calc(100svh-131px)] md:min-h-[calc(100svh-166px)] lg:min-h-[calc(100svh-177px)]">
