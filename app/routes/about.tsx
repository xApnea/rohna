...
export default function About() {
  ...
  return (
    <div id="about" className="min-h-[calc(100svh-131px)] md:min-h-[calc(100svh-172px)] lg:min-h-[calc(100svh-183px)] bg-[url('/resources/images?src=/images/eclipse.png&w=4000&h=4000&fit=cover&format=avif')] bg-cover bg-center">
